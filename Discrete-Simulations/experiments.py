...
from robot_configs.policy_iteration_robot import robot_epoch as policy_epoch
from robot_configs.grid_robot import robot_epoch as grid_epoch
...
experiment_file_name = 'experiment_infinite_value'
runs = 1
...
robots_epoch = [(grid_epoch, 'value_robot'),
                (infinite_view_epoch, 'infinite_view_robot')]#, (policy_epoch, 'policy_iteration_robot')]
