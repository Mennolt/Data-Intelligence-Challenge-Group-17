...
def robot_epoch(robot):
    ...
    print(f'Current pos: {robot.pos}')

    print(f"grid: {grid.cells}")

    print(f'test: {grid.cells[1,1]}')
    print(f'test: {grid.cells[0,0]}')
    print(f'test: {grid.cells.where([-10, -10])}')


    try:
        print(f"illegal: {grid.cells[-1, 0]}")
        print(f"illegal: {grid.cells[-1, -1]}")
        print(f"illegal: {grid.cells[0, -1]}")
